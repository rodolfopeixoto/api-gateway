...
Rails.application.config.middleware.move_before Proxy::ForwardHost, Rack::Attack
Rails.application.config.middleware.use Proxy::ForwardHost, backend: ENV['SERVICE_URL'], streaming: false